...
class menu:
    ...
    def buybook(self):
        ...
        e1=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.name).place(x=150,y=50)
        self.bn=""
        self.bn=self.name.get()
        print(self.bn)
        self.URL='https://www.amazon.in/s?k='+self.bn+'&ref=nb_sb_noss';
